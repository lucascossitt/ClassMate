    ...
    <div class="container my-5">
        ...
        <table v-if="lembretes.length > 0" class="table table-striped table-bordered table-hover align-middle">
            ...
            <tr v-for="lembrete in lembretes" :key="lembrete._id">
                ...
                <td>
                    <div aria-label="Ações do lembrete" class="btn-group" role="group">
                        <button class="btn btn-danger btn-sm" title="Excluir Lembrete"
                                @click="excluirLembrete(lembrete._id)">
